exports.up = function(knex) {
    return knex.schema.createTable('articles', table => {
        ...
        table.integer('quantity').notNullable().checkBetween([1, 10]);
        ...
        table.enu('status', ['pending', 'in_progress', 'completed', 'delivered', 'approved', 'rejected']).defaultTo('pending').notNullable();
        table.enu('language', ['American English', 'British English', 'Canadian English', 'Australian English']).notNullable();
