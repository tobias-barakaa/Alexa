exports.up = function(knex) {
    return knex.schema.createTable('upload_articles', function(table) {
        ...
        table.integer('article_id').unsigned().notNullable();  // Assuming this references the articles being uploaded.
        ...
        table.foreign('article_id').references('id').inTable('articlecreation').onDelete('CASCADE');
    });
};
