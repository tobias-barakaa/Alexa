...
exports.up = function (knex) {
    return knex.schema.createTable('cost_adjust', (table) => {
        ...
        table
          ...
          .nullable()
          .references('id')
          .inTable('order') // References the "order" table
          .notNullable()
          .onDelete('CASCADE'); // Delete adjustments if the order is deleted
...
exports.down = function (knex) {
    return knex.schema.dropTableIfExists('cost_adjust');
};
